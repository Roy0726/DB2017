...
<%
	...
	ArrayList<Syllabus> main_rs = (ArrayList<Syllabus>)session.getAttribute("main_rs");
						...
						<div class="w3-card w3-round w3-white">
							<div class="w3-container w3-padding">
								...
								<div>
									...
									<input type="checkbox" name="one" value="temp1"
										<%if(c1 != null) out.print("checked=\"checked\""); %>>
									one <input type="checkbox" name="two" value="temp2"
										<%if(c2 != null) out.print("checked=\"checked\""); %>>
									two <input type="checkbox" name="three" value="temp3"
		...
		if(sel2.options[i].value == <%=s2%>
						...
						<div style="float: left; padding: 0px; margin: 0px; width: 100%;"
							...
							<table class="courTable" style="width: 100%;" id="main_table">
								...
								<%
									if (main_rs != null)
										for (Syllabus sy : main_rs) {
								%>
								<tr>
									<td><%=sy.getGrade()%></td>
									<td><%=sy.getLect_name()%></td>
									<%-- 
         <td>교과구분</td>
         <td>교과목명</td>
         <td>학점</td>
